<div class="top-free-consult-section">
</div>
<section class="free-consult-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h1>Бесплатная консультация</h1>
                <div class="sub-title-wrap">
                    <h4>Оставьте заявку, <br> и мы свяжемся с Вами</h4>
                    <div class="for-line"></div>
                </div>
                <div class="contact-info-block deskt-info-block">
                    ...
                    <div class="sub-contact-info-block-wrap address-block">
                        ...
                        <a href="https://yandex.ru/maps/org/cronixtour/34060875756/?source=wizbiz_new_text_single" style="margin: 0; display: block"><span style="display: block">Орел, ул.Ленина, 17 <br> ТЦ "Малиновая вода" 1 этаж</span></a>
                    </div>
                    <div class="sub-contact-info-block-wrap">
                        <div class="img-wrap">
            ...
            <div class="col-12">
                <div class="contact-info-block mob-info-block">
                    <div class="sub-contact-info-block-wrap">
                        <div class="img-wrap">
                            <img alt="image" src="{{asset('/images/phone-icon.png')}}"/>
                        </div>
