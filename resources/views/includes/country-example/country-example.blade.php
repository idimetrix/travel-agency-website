<section class="country-example-section"
         style="background: linear-gradient(to bottom,rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('{{$country->mainImage->url}}') no-repeat;
             background: -webkit-linear-gradient(top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(0, 0, 0, 0.65) 100%), url('{{$country->mainImage->url}}') no-repeat;
        ...
        <div class="row">
            <div class="col-12">
                <div class="about-country-wrap">
                    ...
                    @endif
                    <h4 class="country-name" @if(count($country->images) <= 4) style="margin-top: 20px" @endif>{{$country->title}}</h4>
                    <div class="text-wrap">
                        <p>
                            {!! $country->description !!}
                        </p>
