                    ...
                    <div class="insta-photos-block-2">
                        <div class="inst-img-wrap one">
                            <img alt="image" class="lazy"
                                 ...
                                 data-src="{{asset('/images/reviews/42.jpg')}}"/>
                        ...
                        <div class="inst-img-wrap two">
                            <img alt="image" class="lazy"
                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                 data-src="{{asset('/images/reviews/44.jpg')}}"/>
                            <div class="hover-inst-block">
                                <p> Спасибо, что помогли найти тур в Турцию, и за приятный отдых.
                                    <span class="hashtag" style="color: #0b43c6">
                                   <a target="_blank"
                                      href="https://www.instagram.com/cronixtour/">#cronixtour  #orel</a>
                                </span>
                        ...
                        <div class="inst-img-wrap three">
                            <img alt="image" class="lazy"
                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                 data-src="{{asset('/images/reviews/43.jpg')}}"/>
                            <div class="hover-inst-block">
                                <p>Вчера вернулись из Мармариса все очень понравилось
                                    <span class="hashtag" style="color: #0b43c6">
                                   <a target="_blank"
                                      href="https://www.instagram.com/cronixtour/">#cronixtour  #orel</a>
                                </span>
                        ...
                        <div class="inst-img-wrap four">
                            <img alt="image" class="lazy"
                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                 data-src="{{asset('/images/reviews/45.jpg')}}"/>
                            <div class="hover-inst-block">
                        ...
                        <div class="inst-img-wrap five">
                            <img alt="image" class="lazy"
                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                 data-src="{{asset('/images/reviews/47.jpg')}}"/>
                            <div class="hover-inst-block">
                                <p>Приехали из санатория оооооочень довольные!!!
                                    <span class="hashtag" style="color: #0b43c6">
                                   <a target="_blank"
                                      href="https://www.instagram.com/cronixtour/">#cronixtour  #orel</a>
                                </span>
                        ...
                        <div class="inst-img-wrap six">
                            <img alt="image" class="lazy"
                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                 data-src="{{asset('/images/reviews/46.jpg')}}"/>
                            <div class="hover-inst-block">
                                <p>Отдохнули хорошо)
                                    <span class="hashtag" style="color: #0b43c6">
